...
//TODO: Change AsyncServer API to use ServerInfo objects and folderId (int) instead of ipaddress, portNumber, folderPath, etc. Only public method that accepts IP,Port should be RequestServerInfo()
